...
export default function PlaceOrderScreen(props) {
  ...
  const placeOrderHandler = () => {
    dispatch(createOrder({ ...cart, orderItems: cart.cartItems })); /*here it's renaming cartitems to orderitems
    because in backend, i expect order items not cart items, to do that rap cart into curley brackets and 
    put triple dots before cart*/
  };
  useEffect(() => {
    if (success) {
